...
public class MelonServiceImpl implements MelonService {
    ...
    private GrayVO convert(GrayDO grayDO) throws ClassNotFoundException {
        ...
        Class<? extends GrayCondition> clazz = (Class<? extends GrayCondition>)Class.forName(grayDO.getConditionClass());
        grayVO.setCondition(JSONObject.parseObject(grayDO.getConditionJson(), clazz));
